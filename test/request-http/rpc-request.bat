...
SET DEVICE_ACCESS_TOKEN=nXb3sEjoNcui1KnHYIff
SET DEVICE_ID=04de50a0-b27d-11f0-86b8-4d4474c0a366
SET THINGSBOARD_HOST_NAME=localhost:8080
SET DATA_FILE=rpc-data.json
SET JWT_TOKEN=Your_Token

REM Send RPC request
curl.exe -X POST -d @%DATA_FILE% http://%THINGSBOARD_HOST_NAME%/api/v1/%DEVICE_ACCESS_TOKEN%/rpc --header "Content-Type:application/json"
